...
class AlarmService : Service() {
    ...
    private fun buildServiceNotification(): Notification {
        val stopPi = PendingIntent.getBroadcast(
            this, 0,
            Intent(this, com.remembrall.app.engine.AlarmReceiver::class.java).apply {
                action = com.remembrall.app.engine.AlarmReceiver.ACTION_DISMISS
                putExtra(EXTRA_ID, -1L)
            },
            PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
        )
        return NotificationCompat.Builder(this, NotifyHelper.CHANNEL_ALARM)
            .setSmallIcon(R.drawable.ic_stat_remembrall)
    ...
    companion object {
        ...
        const val ACTION_STOP = "com.remembrall.app.ACTION_STOP_ALARM"
