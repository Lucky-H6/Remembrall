...
class AlarmReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                if (reminder.repeatMode == com.memoryball.app.data.model.RepeatMode.ONCE) {
    ...
    companion object {
        const val ACTION_DISMISS = "com.memoryball.app.ACTION_DISMISS"
        const val ACTION_DISMISSED = "com.memoryball.app.ALARM_DISMISSED"
    }
}
