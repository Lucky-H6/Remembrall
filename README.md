...
基于时间和地理位置的智能提醒 Android App，首发适配小米 17 Pro Max (MIUI/HyperOS)。

名字取自《哈利·波特》中纳威·隆巴顿的记忆球——在合适的时间、合适的地点，把该记得的事送回来。
...
在小米设备上，用户需手动开启以下设置以保证提醒不丢失（App 内"设置"页有快捷引导）：
...
- MIUI 后台限制可能导致地点提醒延迟，需用户配合完成上述设置
